...
import {PageAidemagaComponent} from './pages/aidemaga/page-aidemaga/page-aidemaga.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'aidemagas',
        component: PageAidemagaComponent,
        canActivate: [ApplicationGuardService]
      },
      {
        path: 'nouveauclient',
      ...
      {
        path: 'nouvelleproduitsendommage',
        component: NouvelleCmdCltFrsComponent,
        canActivate: [ApplicationGuardService],
        data: {
          origin: 'aidemaga'
      ...
      {
        path: 'livreurs',
        component: PageLivreurComponent,
        canActivate: [ApplicationGuardService]
      },
      {
